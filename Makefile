# This Makefile is for the Statistics::RVector extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Statistics/RVector.pm]
#     AUTHOR => q[Josh Ballard <josh@oofle.com>]
#     BUILD_REQUIRES => {  }
#     NAME => q[Statistics::RVector]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Statistics/RVector.pm]
...
MAKE = make
FULLEXT = Statistics/RVector
BASEEXT = RVector
PARENT_NAME = Statistics
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Statistics/RVector.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Statistics/RVector.pm
...
TO_INST_PM = lib/Statistics/RVector.pm

PM_TO_BLIB = lib/Statistics/RVector.pm \
...
DISTNAME = Statistics-RVector
DISTVNAME = Statistics-RVector-0.1
...
manifypods : pure_all  \
	lib/Statistics/RVector.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Statistics/RVector.pm $(INST_MAN3DIR)/Statistics::RVector.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Statistics-RVector' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.1' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           ~' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - Josh Ballard <josh@oofle.com>' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Josh Ballard &lt;josh@oofle.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Statistics/RVector.pm blib/lib/Statistics/RVector.pm 
